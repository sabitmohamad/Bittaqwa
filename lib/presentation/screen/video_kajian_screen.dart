import 'package:dashboard_islami/data/video_kajian_data.dart';
import 'package:dashboard_islami/presentation/screen/video_kajian_detail_screen.dart';
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => VideoKajianDetailScreen(
                    ...
                    thumbnail: videos[index]['thumnail']!,
                  ),
                ),
              );
            },
